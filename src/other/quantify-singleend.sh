...
do
   ...
   echo "`date`"
   echo $base
   ~/libs/kallisto-0.43.0/kallisto quant -i /bigcode/pesho/resources/transcriptomes/Homo_sapiens.GRCh38.rel79.cdna.all.idx -o $OUTPUT_DIR/$base --single -l 100 -s 1 $longfn &
